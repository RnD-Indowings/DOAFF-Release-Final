...
tk.Label(root, text="Target Coordinate Input", font=("Arial", 14, "bold")).pack(pady=10)
...
run_btn = tk.Button(root, text="RUN", bg="green", fg="white", font=("Arial", 12, "bold"), width=22, command=run_code)
run_btn.pack(pady=15)
status_var = tk.StringVar(value="Idle")

tk.Label(root, textvariable=status_var, font=("Arial", 11, "bold"), fg="purple").pack()
...
output_box = tk.Text(
    terminal_frame, height=18, width=70, bg="black", fg="lime", font=("Courier", 10), yscrollcommand=scrollbar.set
)
