...
_logo_path = "/home/nisha-/Downloads/xx.png"
try:
    ...
    _white_bg = Image.new("RGBA", (_canvas_w, _canvas_h), (0, 0, 0, 255))
...
try:
    _tm_raw = Image.open("/home/nisha-/Downloads/gui_logo.jpg").convert("RGB")
